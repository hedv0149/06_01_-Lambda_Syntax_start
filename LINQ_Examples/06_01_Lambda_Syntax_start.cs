...
namespace LINQ_Examples
{
    class Program
    {
        ...
        {
            Console.WriteLine("Customers From GA:");
            foreach (Customer c in customers)
            {
                if (c.State == "GA")
                {
                    foreach (string d in c.Purchases)
                        Console.WriteLine("{0} {1}", c.First, c.Last + " " + d);

                }
            }
            Console.WriteLine();
        }
        static void CustomersFromOR()
        {
            Console.WriteLine("Customers From OR:");
            foreach (Customer c in customers)
            {
                if (c.State == "OR")
                {
        ...
        static void AllExchangedPricesLessThan()
        {
            Console.WriteLine("Prices Less Than 1000:");
            foreach (Customer c in customers)
            {
                if (c.Price < 1000)
                {
        ...
        static void AllFirstNames()
        {
            Console.WriteLine("Firstnames Of All Customers:");
            foreach (Customer c in customers)
            {
        ...
        static void AllStateAbbreviationsThatAreTheSame()
        {
            //Not working
        ...
        static void FirstThreeCustomers()
        {
            //Not working
